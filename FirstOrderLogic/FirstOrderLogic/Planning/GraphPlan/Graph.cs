...
public class Graph {
    ...
    public bool StateNotMutex(int tl, List<ISentence> goals) {
    ...
    private bool IsMutex(Node n1, Node n2) {
        ...
        return n1 switch {
            StateNode s1 when n2 is StateNode s2 => IsInconsistentSupport(s1, s2) || IsInconsistent(s1.Literal, s2.Literal),
            ActionNode a1 when n2 is ActionNode a2 => IsInconsistentEffects(a1, a2) || IsInterference(a1, a2) || IsConflictingNeeds(a1, a2),
    ...
    private bool IsConflictingNeeds(ActionNode a1, ActionNode a2) {
        return a1.Action.Preconditions.Any(preCon1 => a2.Action.Preconditions.Any(preCon2 => IsInconsistent(preCon1, preCon2)));
    }
