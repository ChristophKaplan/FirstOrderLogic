...
public class Preliminaries: Section {
    protected override string Content() {
        return ForgetDefinition() + SkepForgetDefinition() + @"\cite{lin1994forget} or \cite{lang2003propositional}";
    }

    public Preliminaries(PropositionalLogic logic) : base(logic) {
    }
